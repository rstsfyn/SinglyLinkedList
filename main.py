...
def menu():
  while True:
    ...
    if pilihan == 1:
      my_linked_list = LinkedList(input("Masukan angka untuk membuat Linked list baru: "))
    elif pilihan == 2:
      ...
      my_linked_list.print_list()
      my_linked_list.insert(int(input("Masukan index yang ingin di insert: ")),input("Masukan angka baru untuk insert: "))
    elif pilihan == 7:
      my_linked_list.print_list()
      my_linked_list.remove(int(input("Masukan index yang ingin diremove: "))).value
    elif pilihan == 8:
